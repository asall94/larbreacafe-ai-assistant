...
def mock_kb():
    ...
    with patch('ai_agent.EnrichedKnowledgeBase') as mock:
        ...
        kb_instance.get_products.return_value = [
            {"nom": "KSF Honey Ethiopia", "prix": "27.00", "categorie": "cafés"}
        ]
        yield kb_instance
...
class TestToolExecution:
    ...
    def test_search_knowledge(self, agent, mock_kb):
        ...
        mock_kb.search.return_value = [
            {
                "content": "KSF Honey Ethiopia - Café de spécialité 27.00€",
                "type": "produit",
                "score": 0.92
            }
        ]
...
class TestValidation:
    ...
    def test_validate_boutique_existence(self, agent, mock_kb):
        ...
        response_valid = "Le Terres de Cafe Corbeil est ouvert de 11:30 à 14:00."
        context_valid = "[boutique trouvé] Terres de Cafe Corbeil - Horaires: 11:30-14:00"
        ...
        context_positive = "[boutique trouvé] Terres de Cafe Corbeil-Essonnes - Essonne 91"
    ...
    def test_validate_price_hallucination(self, agent):
        ...
        response_with_price = "Le KSF Honey coûte 35€"
        context = "KSF Honey - Café d'Éthiopie (prix non disponible)"
        ...
        assert "35€" not in validated or "disponibles" in validated or not is_valid
...
class TestProductSearch:
    ...
    def test_search_with_preferences(self, agent, mock_kb):
        ...
        mock_kb.search.return_value = [
            {"nom": "Fazendas Brazil", "description": "Café brésilien doux", "categorie": "cafés", "content": "Fazendas Brazil - doux"}
        ]
        
        result = agent.search_knowledge("café doux")
    ...
    def test_search_no_match(self, agent, mock_kb):
        ...
        result = agent.search_knowledge("thé matcha")  # Not in catalog
